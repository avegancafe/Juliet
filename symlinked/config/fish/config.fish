...
function logs
    set -l service (echo '["j2-network-manger", "network-intel-dashboard", "network-intel-dashboard-qa"]' | jq -r .[] | fzf --reverse --height 40% --prompt "Which service logs would you like to see? ")
