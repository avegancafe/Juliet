...
local buffer_bg = { '#212026', 222, 'buffer_bg' }
...
local normal = (function()
	if vim.g.void_nvim_transparent_bg ~= true then
...
local highlight_groups = {
	...
	ErrorMsg = { fg = fg0, bg = bg1 }, -- error messages on the command line
	...
	TablineSel = { fg = fg1, bg = section_bg },
...
return {
	highlight_group_normal = highlight_group_normal,
